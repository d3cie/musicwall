...
export default function Edit(props) {
  ...
  function CountriesList() {
    let options = [];
    options.push(<option value={'none'}>22</option>)
  ...
  return (
    ...
    <React.Fragment>
      ...
      <ProfileCont>
        ...
        ></ProfileIcon>
        <ChangeProfile htmlFor='upload-photo'
      ...
      <ButtonContOut>
        <PrimaryButton style={{ background: vars.LIGHT_GREY, borderColor: vars.LIGHER_GREY }} onClick={() => { router.back() }} buttonTitle={"Cancel"} />
